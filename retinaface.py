...
from utils1.anchors import Anchors
from utils1.config import cfg_mnet, cfg_re50
from utils1.utils import (Alignment_1, compare_faces, letterbox_image,
                         preprocess_input)
from utils1.utils_bbox import (decode, decode_landm, non_max_suppression,
...
class Retinaface(object):
    ...
    _defaults = {
        ...
        #   retinaface训练完的权值路径
        #----------------------------------------------------------------------#
        "retinaface_model_path" : 'C:\\Users\\风吟\PycharmProjects\\pythonProject2\\facenet-retinaface-pytorch-main\\model_data\\Retinaface_mobilenet0.25.pth',
        #----------------------------------------------------------------------#
        ...
        "facenet_model_path"    : 'C:\\Users\\风吟\\PycharmProjects\\pythonProject2\\facenet-retinaface-pytorch-main\\model_data\\facenet_mobilenet.pth',
        #----------------------------------------------------------------------#
    ...
    def __init__(self, encoding=0, **kwargs):
        ...
        try:
            self.known_face_encodings = np.load("C:\\Users\\风吟\\PycharmProjects\\pythonProject2\\facenet-retinaface-pytorch-main\\model_data\\{backbone}_face_encoding.npy".format(backbone=self.facenet_backbone))
            self.known_face_names     = np.load("C:\\Users\\风吟\\PycharmProjects\\pythonProject2\\facenet-retinaface-pytorch-main\\model_data/{backbone}_names.npy".format(backbone=self.facenet_backbone))
        except:
            if not encoding:
