    ...
    def __init__(self, cfg = None, pre_train = False, phase = 'train'):
        ...
        if cfg['name'] == 'mobilenet0.25':
            ...
            if pre_train:
                ...
                checkpoint = torch.load("C:\\Users\\风吟\\PycharmProjects\\pythonProject2\\facenet-retinaface-pytorch-main\\model_data\\mobilenetV1X0.25_pretrain.tar", map_location=torch.device('cpu'))
